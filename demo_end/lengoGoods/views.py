...
def cart(request):
    ...
    return render(request, 'cart.html',
                  {'uname': uname, 'dingdan': dingdan, 'uuu': uuu, 'chao': chao, 'zhongxin': zhongxin})
...
def detail(request, a):
    ...
    return render(request, 'detail.html',
                  {'b': b, 'uname': uname, 'dingdan': dingdan, 'uuu': uuu, 'chao': chao, 'zhongxin': zhongxin})
...
def list(request, a):
    if int(a) == 1:
        ...
        return render(request, 'list.html',
                      {'b': b, 'a': a, 'c': c, 'uname': uname, 'dingdan': dingdan, 'uuu': uuu, 'chao': chao,
                       'zhongxin': zhongxin})
    elif int(a) == 2:
...
def jisuan(request, d):
    ...
    if request.session.get('uname') is not None:
        ...
        dingdan = '<a href="/user/user_center_site/">全部订单</a>'
    return render(request, 'place_order.html',
                  {'dingdan': dingdan, 'number': number, 'price': price, 'b': b, 'a': a, 'uname': uname, 'uuu': uuu,
                   'chao': chao, 'zhongxin': zhongxin})
